...
class GuiFiles extends StatefulWidget {
  const GuiFiles({Key? key}) : super(key: key);

  @override
  State<GuiFiles> createState() => _GuiFilesState();
}
...
class GuiFile extends StatefulWidget {
  const GuiFile({Key? key}) : super(key: key);

  @override
  State<GuiFile> createState() => _GuiFileState();
}

class _GuiFileState extends State<GuiFile> {
  chonAnh() async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(
        type: FileType.custom,
